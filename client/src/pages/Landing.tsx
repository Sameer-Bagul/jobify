        ...
        <section className="max-w-7xl mx-auto px-6 pt-20 pb-24 grid lg:grid-cols-2 gap-16 items-center">
          <div className="text-left">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
              ...
              <Link to="/recruiter" className="btn-secondary text-lg px-8 py-4 flex items-center justify-center gap-2">
          ...
          <div className="rounded-[3rem] bg-gradient-to-br from-purple-600/40 via-blue-600/40 to-pink-600/40 p-[1px]">
            <div className="rounded-[3rem] bg-dark-950 px-8 py-20 text-center relative overflow-hidden">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-6 relative z-10">
                <Link to="/signup" className="btn-primary text-xl px-12 py-5 shadow-2xl">
                  Get Started for Free
                </Link>
                <Link to="/recruiter" className="text-white font-bold hover:text-purple-400 transition-colors underline decoration-purple-500 decoration-2 underline-offset-8">
