    ...
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
      <div className="card border border-dark-600">
        <div className="flex items-center justify-between mb-2">
          <span className="text-gray-600 text-sm">Daily Usage</span>
          <Zap className="h-4 w-4 text-yellow-400" />
        </div>
        <div className="text-2xl font-bold text-dark-walnut">
          {stats.dailySent} / {stats.dailyLimit}
        </div>
        <div className="mt-2 h-2 bg-gray-200 rounded-full overflow-hidden">
          <div 
            className="h-full bg-gradient-to-r from-dark-walnut to-dark-950 rounded-full transition-all"
      ...
      <div className="card border border-dark-600">
        ...
        <div className="text-2xl font-bold text-dark-walnut">{stats.totalSent}</div>
      ...
      <div className="card border border-dark-600">
        <div className="flex items-center justify-between mb-2">
          ...
          <TrendingUp className="h-4 w-4 text-tangerine-dream" />
        </div>
        <div className="text-2xl font-bold text-dark-walnut">{successRate}%</div>
      ...
      <div className="card border border-dark-600">
        <div className="flex items-center justify-between mb-2">
          ...
          <Crown className="h-4 w-4 text-tangerine-dream" />
        </div>
        <div className="text-2xl font-bold text-dark-walnut capitalize">{stats.planName}</div>
