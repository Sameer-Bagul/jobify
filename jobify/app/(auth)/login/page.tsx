        ...
        <div className="max-w-md w-full mx-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-end ml-1">
                ...
                <Link href="/forgot-password" title="Forgot Password" className="text-xs font-bold text-purple-400 hover:text-purple-300 transition-colors">
                  Reset password
                </Link>
              </div>
              <div className="relative group">
          ...
          <div className="mt-12 text-center">
            <p className="text-gray-500 text-sm font-medium">
              New to Jobify?{' '}
              <Link href="/signup" className="text-white hover:text-purple-400 font-bold transition-colors underline underline-offset-4 decoration-purple-500/30 hover:decoration-purple-500">
                Create an account
              </Link>
            </p>
          </div>
